...
export default function BlogPage({ params }: { params: Promise<{ id: string }> | { id: string } }) {
  // Check if params is a Promise, and if so, unwrap it
  ...
  // For debugging - show all collected debug info
    ...
    return (
      <>
        ...
        <div className="container py-20 text-center">
          ...
          <div className="mb-4 p-4 bg-slate-100 dark:bg-slate-800 rounded-md overflow-auto">
            <p className="font-mono text-sm">Debug info:</p>
            <pre className="font-mono text-sm">{JSON.stringify(debugInfo, null, 2)}</pre>
          </div>
